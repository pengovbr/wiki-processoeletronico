...
7.2.	O usuário externo pode assinar documentos externos utilizando assinatura qualificada e avançada?
-----------------------------------------------------------------------------------------------------
A partir da versão 1.4.0, o usuário externo pode assinar documentos externos utilizando assinatura avançada (GOV.BR) e qualificada (Certificado A3 em Nuvem e Token A1).


7.3.	O usuário externo pode assinar documentos com carimbo de tempo?
--------------------------------------------------------------------
