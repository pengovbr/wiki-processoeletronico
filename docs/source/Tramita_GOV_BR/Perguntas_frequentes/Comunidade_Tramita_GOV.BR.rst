...
Para os demais gestores do órgão, a solicitação de acesso deve ser feita por meio do `formulário de coleta de informações <https://forms.cloud.microsoft/Pages/ResponsePage.aspx?id=zxNiRXNwxke_SUG2VK1Em-ygyW6lDpdKmQmrZrJ3cHFURjBFVTRVVEFTSVhGQTdFSEpaTDhTUTRZQi4u>`_ dos Gestores de Protocolo dos órgãos, e pela ciência e consentimento do Termo de Uso e Aviso de Privacidade relacionados à comunidade. Após o envio do formulário, estando ele em conformidade com as diretrizes internas, o acesso à comunidade é concedido ao solicitante. 
